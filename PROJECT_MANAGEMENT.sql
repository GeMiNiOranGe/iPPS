...
--1 
DELETE FROM EMPLOYEE_BELONG_TO_PROJECT WHERE PROJECT_ID = 'PRJ00001'

--2
DELETE JOIN_JOB
FROM JOIN_JOB JOIN JOB ON JOIN_JOB.JOB_ID = JOB.ID
WHERE JOB.PROJECT_ID = 'PRJ00001' 

--3
DELETE DOCUMENT_NATIVE_FILE_FORMAT
FROM DOCUMENT JOIN DOCUMENT_NATIVE_FILE_FORMAT ON DOCUMENT.ID = DOCUMENT_NATIVE_FILE_FORMAT.ID

--4
DELETE DOCUMENT
FROM DOCUMENT JOIN JOB ON DOCUMENT.JOB_ID = JOB.ID
WHERE JOB.PROJECT_ID = 'PRJ00001'

--5
DELETE FROM JOB WHERE PROJECT_ID = 'PRJ00001'

--6
DELETE FROM JOIN_PROJECT WHERE PROJECT_ID = 'PRJ00001'

--7
DELETE FROM PROJECT WHERE ID = 'PRJ00001'

delete from ACCOUNT
delete from DEPARTMENT
delete from DOCUMENT
delete from DOCUMENT_NATIVE_FILE_FORMAT
delete from EMPLOYEE
delete from EMPLOYEE_BELONG_TO_PROJECT
delete from EMPLOYEE_PHONE_NUMBER
delete from IMPLEMENT_PROJECT
delete from JOB
delete from JOIN_JOB
...
VALUES 	('EMP00001', 	'PRJ00001'),
		...
		('EMP00014',	'PRJ00003'),
		('EMP00015',	'PRJ00003')
select * from EMPLOYEE_BELONG_TO_PROJECT
-- ACCOUNT
INSERT INTO ACCOUNT
